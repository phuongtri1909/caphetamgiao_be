                ...
                <div class="active-filters">
                    ...
                    @if (request('order_code'))
                        <span class="filter-tag">
                            ...
                            <a href="{{ request()->url() }}?{{ http_build_query(request()->except('order_code')) }}" class="remove-filter">×</a>
                        </span>
                    @endif
                    @if (request('customer'))
                        <span class="filter-tag">
                            <span>Khách hàng: {{ request('customer') }}</span>
                            <a href="{{ request()->url() }}?{{ http_build_query(request()->except('customer')) }}" class="remove-filter">×</a>
                        </span>
                    @endif
                    @if (request('status'))
                        <span class="filter-tag">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="action-buttons-wrapper">
                                            <a href="{{ route('admin.orders.show', $order->id) }}" class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
